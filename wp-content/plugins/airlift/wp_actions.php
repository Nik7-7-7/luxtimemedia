	...
	class ALWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) {
				ALAccount::addAccount($this->settings, 'bb8af0b45ff6c360ddbfeb0e2757a7fc', 'db7be121ac47722e5dc42af318c657dc');
		ALAccount::updateApiPublicKey($this->settings, 'bb8af0b45ff6c360ddbfeb0e2757a7fc');
			}
