 ...
 *
 * @package     AutomatorWP\Integrations\weForms\Triggers\Anonymous_Submit_Form
...
class AutomatorWP_weForms_Anonymous_Submit_Form extends AutomatorWP_Integration_Trigger {

    public $integration = 'weforms';
    public $trigger = 'weforms_anonymous_submit_form';
...
new AutomatorWP_weForms_Anonymous_Submit_Form();