 ...
 * Submit Form
 *
 * @package     AutomatorWP\Integrations\Everest_Forms\Triggers\Submit_Form
...
class AutomatorWP_Everest_Forms_Submit_Form extends AutomatorWP_Integration_Trigger
{
    public $integration = 'everest_forms';
    public $trigger = 'everest_forms_submit_form';
...
new AutomatorWP_Everest_Forms_Submit_Form();
