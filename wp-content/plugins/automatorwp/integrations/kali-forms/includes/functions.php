 ...
 * Functions
 *
 * @package     AutomatorWP\Kaliforms\Functions
 * @since       1.0.0
 */
 ...
 * @return array
 */
function automatorwp_kali_forms_get_form_fields_values( $fields ) {
...
function automatorwp_kali_forms_parse_automation_tags( $parsed_content, $replacements, $automation_id, $user_id, $content ) {
    ...
    foreach( $triggers as $trigger ) {
        ...
        if( $trigger_args['integration'] !== 'kali_forms' ) {
            continue;
        }
...
add_filter( 'automatorwp_parse_automation_tags', 'automatorwp_kali_forms_parse_automation_tags', 10, 5 );
