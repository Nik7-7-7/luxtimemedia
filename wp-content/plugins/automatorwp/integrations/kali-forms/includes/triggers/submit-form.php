 ...
 * Submit Form
 *
 * @package     AutomatorWP\Integrations\Kali-Forms\Triggers\Submit_Form
...
class AutomatorWP_Kali_Forms_Submit_Form extends AutomatorWP_Integration_Trigger {
   
    public $integration = 'kali_forms';
    public $trigger = 'kali_forms_submit_form';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'select_option'     => __( 'User submits a <strong>form</strong>', 'automatorwp' ),
            ...
            'action'            => 'kaliforms_before_form_process_action',
     ...
     */
    public function listener( $data_form) {
           
        $form_id = absint($data_form['data']['formId']);
        ...
        $form_fields = automatorwp_kali_forms_get_form_fields_values( $data_form['data'] );
...
new AutomatorWP_Kali_Forms_Submit_Form();