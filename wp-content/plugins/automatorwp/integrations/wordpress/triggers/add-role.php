 ...
 * Add Role
 *
 * @package     AutomatorWP\Integrations\WordPress\Triggers\Add_Role
...
class AutomatorWP_WordPress_Add_Role extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User gets added to role', 'automatorwp' ),
            'select_option'     => __( 'User gets <strong>added</strong> to role', 'automatorwp' ),
            /* translators: %1$s: Role. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User gets added to %1$s %2$s time(s)', 'automatorwp' ), '{role}', '{times}' ),
            /* translators: %1$s: Role. */
            'log_label'         => sprintf( __( 'User gets added to %1$s', 'automatorwp' ), '{role}' ),
