...
class AutomatorWP_WordPress_Anonymous_Comment_Post_Taxonomy extends AutomatorWP_Integration_Trigger {
    ...
    public function __construct( $integration ) {
        ...
        $this->trigger = $integration . '_anonymous_comment_post_taxonomy';
...
new AutomatorWP_WordPress_Anonymous_Comment_Post_Taxonomy( 'wordpress' );
new AutomatorWP_WordPress_Anonymous_Comment_Post_Taxonomy( 'comments' );