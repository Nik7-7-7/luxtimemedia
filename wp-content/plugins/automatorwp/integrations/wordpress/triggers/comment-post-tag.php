 ...
 * Comment Post Tag
 *
 * @package     AutomatorWP\Integrations\WordPress\Triggers\Comment_Post_Tag
...
class AutomatorWP_WordPress_Comment_Post_Tag extends AutomatorWP_Integration_Trigger {
    ...
    public function __construct( $integration ) {
        ...
        $this->trigger = $integration . '_comment_post_tag';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User comments on a post of a tag', 'automatorwp' ),
            'select_option'     => __( 'User comments on a post of <strong>a tag</strong>', 'automatorwp' ),
...
new AutomatorWP_WordPress_Comment_Post_Tag( 'wordpress' );
new AutomatorWP_WordPress_Comment_Post_Tag( 'comments' );