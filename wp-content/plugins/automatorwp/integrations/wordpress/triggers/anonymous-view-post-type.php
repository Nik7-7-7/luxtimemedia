<?php
/**
 * Anonymous View Post Type
 *
 * @package     AutomatorWP\Integrations\WordPress\Triggers\Anonymous_View_Post_Type
...
class AutomatorWP_WordPress_Anonymous_View_Post_Type extends AutomatorWP_Integration_Trigger {
    ...
    public function __construct( $integration ) {
        ...
        $this->trigger = $integration . '_anonymous_view_post_type';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'anonymous'         => true,
            'label'             => __( 'Guest views a post of a type', 'automatorwp' ),
            'select_option'     => __( 'Guest views <strong>a post of a type</strong>', 'automatorwp' ),
            /* translators: %1$s: Post type. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'Guest views %1$s %2$s time(s)', 'automatorwp' ), '{post_type}', '{times}' ),
            /* translators: %1$s: Post type. */
            'log_label'         => sprintf( __( 'Guest views %1$s', 'automatorwp' ), '{post_type}' ),
...
new AutomatorWP_WordPress_Anonymous_View_Post_Type( 'wordpress' );
new AutomatorWP_WordPress_Anonymous_View_Post_Type( 'posts' );