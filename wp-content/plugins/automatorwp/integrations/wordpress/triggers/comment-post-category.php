...
class AutomatorWP_WordPress_Comment_Post_Category extends AutomatorWP_Integration_Trigger {
    ...
    public function __construct( $integration ) {
        ...
        $this->trigger = $integration . '_comment_post_category';
...
new AutomatorWP_WordPress_Comment_Post_Category( 'wordpress' );
new AutomatorWP_WordPress_Comment_Post_Category( 'comments' );