 ...
 *
 * @package     AutomatorWP\Integrations\WordPress\Triggers\Publish_Post_Category
...
class AutomatorWP_WordPress_Publish_Post_Category extends AutomatorWP_Integration_Trigger {
    ...
    public function __construct( $integration ) {
        ...
        $this->trigger = $integration . '_publish_post_category';
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User publishes a post in a category', 'automatorwp' ),
            'select_option'     => __( 'User publishes a post in <strong>a category</strong>', 'automatorwp' ),
...
new AutomatorWP_WordPress_Publish_Post_Category( 'wordpress' );
new AutomatorWP_WordPress_Publish_Post_Category( 'posts' );