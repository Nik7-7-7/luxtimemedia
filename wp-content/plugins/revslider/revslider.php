...
update_option( 'revslider-code', 'GPL001122334455AA6677BB8899CC000' );
...
define('RS_TP_TOOLS',			'6.7.21'); //holds the version of the tp-tools script, load only the latest!
