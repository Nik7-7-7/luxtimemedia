...
<h3><?php esc_html_e('Announcements', 'ulp');?></h3>

<div class="ulp-instructor-dashboard-bttn">
    <a href="<?php echo esc_url($addNewLink);?>" class="btn btn-primary pointer"><?php esc_html_e('Add New', 'ulp');?></a>
</div>

<?php if ($items):?>
    <div class="ulp-instructor-dashboard-announcement-list ulp-instructor-dashboard-list">
    <div class="ulp-instructor-item-list-head">
     <div class="ulp-instructor-item-list-row">
        <div class="ulp-instructor-item-list-col ulp-instructor-item-list-title"><?php esc_html_e('Announcement Title', 'ulp');?></div>
			...
			?>
             ...
             <div class="ulp-instructor-item-list-col ulp-instructor-item-list-title">
                    ...
                    <div  class="ulp-instructor-item-list-options">
                        <span><a href="<?php echo add_query_arg(['tab' => 'add-edit', 'type' => 'ulp_announcement', 'postId' => $post->ID], $baseUri);?>"><?php esc_html_e('Edit', 'ulp');?></a></span> |
                ...
                <div class="ulp-instructor-item-list-col ulp-instructor-item-list-course">
                    ...
                    <?php else:?>
                        <?php $temporaryCourseId = $announcementObject->getCourseIdByAnnouncement($post->ID);?>
