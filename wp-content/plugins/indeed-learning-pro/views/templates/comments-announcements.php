...
if ( post_password_required() ) {
	return;
			...
			$course_id =$object->getCourseIdByAnnouncement($postId);
...
<div class="ulp-comments-wrapper">
	...
	$defaults = array(
		...
		'comment_field' => '<p class="comment-form-comment"><label for="comment" class="screen-reader-text">' . esc_html__( 'Comment', 'ulp' ) . '</label><textarea id="comment" name="comment" cols="45" rows="1" placeholder="Enter your comment" aria-required="true"></textarea></p>',
		'comment_notes_before' => null,
		'comment_notes_after'  => null,
		'id_form'              => 'commentform',
		'id_submit'            => 'submit',
		'title_reply'          => '',
		'label_submit'         => apply_filters( 'generate_post_comment', esc_html__( 'Post Comment', 'ulp' ) ),
	);
?>
