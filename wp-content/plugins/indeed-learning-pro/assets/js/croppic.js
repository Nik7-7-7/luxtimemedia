...
"use strict";
	...
	Croppic.prototype = {
      ...
      var formHtml = '<form class="' + that.id + '_imgUploadForm ulp-visibility-hidden">  <input type="file" name="img" id="' + that.id + '_imgUploadField">  </form>';
		...
		createModal: function(){
			...
			var modalHTML =  '<div id="croppicModal">'+'<div id="croppicModalObj" class="ulp-cst-croppic ulp-croppicModalObj" style = " width:'+ that.objW +'px; height:'+ that.objH +'px; margin-top:'+ marginTop +'px;"> </div>'+'</div>';
		...
		initCropper: function(){
			...
			that.img.wrap('<div class="cropImgWrapper ulp-cropImgWrapper" style = " width:'+that.objW+'px; height:'+that.objH+'px;"></div>');
		...
		createCropControls: function(){
			...
			html =  '<div class="cropControls cropControlsCrop">'+ cropControlZoomMuchIn + cropControlZoomIn + cropControlZoomOut + cropControlZoomMuchOut + cropControlRotateLeft + cropControlRotateRight + '<span id="ulp-custom-controls">' + cropControlCrop + ' <span class="ulp_delimiter">|</span> ' + cropControlReset + '</span></div>';
        ...
        CreateFallbackIframe: function () {
            ...
            if (!that.isAjaxUploadSupported()) {
                ...
                var myContent = '<!DOCTYPE html>'
                                ...
                                + '<body>'
                                + '<form '
                                + 'class="' + that.id + '_upload_iframe_form ulp-display-none" '
