    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function insertLegend() {
            ...
            for (var i = 0; i < entries.length; ++i) {
                ...
                fragments.push(
                    '<td class="legendColorBox"><div style= " border:1px solid ' + options.legend.labelBoxBorderColor + ';"><div class="ulp-legendColorBox-inbox" tyle =" border:5px solid ' + entry.color + ';"></div></div></td>' +
