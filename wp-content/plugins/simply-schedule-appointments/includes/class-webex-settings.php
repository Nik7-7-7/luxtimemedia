<?php
/**
 * Simply Schedule Appointments Webex Settings.
 *
 * @since   3.7.1
 ...
 * @since 3.7.1
 */
class SSA_Webex_Settings extends SSA_Settings_Schema {
	/**
	 * Parent plugin class.
	 *
	 * @since 0.0.3
	...
	/**
	 * Get schema for settings to be stored on the database.
	 *
	 * @since 5.6.0
	 *
