...
class STM_LMS_Certificate_Builder {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'pdfjs', STM_LMS_PRO_URL . '/assets/js/certificate-builder/pdf.min.js', array(), STM_LMS_PRO_VERSION, true );
		wp_enqueue_script( 'qrcode', STM_LMS_PRO_URL . '/assets/js/certificate-builder/qrcode.min.js', array(), STM_LMS_PRO_VERSION, true );
		wp_enqueue_script( 'pdfjs_worker', STM_LMS_PRO_URL . '/assets/js/certificate-builder/pdf.worker.min.js', array(), STM_LMS_PRO_VERSION, true );
		wp_enqueue_script( 'masterstudy_certificate_fonts', STM_LMS_PRO_URL . '/assets/js/certificate-builder/certificates-fonts.js', array(), STM_LMS_PRO_VERSION, true );
	}
	...
	public function admin_page() {
		...
		wp_enqueue_style( 'masterstudy_certificate', STM_LMS_PRO_URL . '/assets/css/certificate-builder/main.css', null, STM_LMS_PRO_VERSION );
