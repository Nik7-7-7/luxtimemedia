 ...
 * @package RSSSL\Security\WordPress\Two_Fa
 */
 ...
 */
require_once __DIR__ . '/class-rsssl-two-factor-compat.php';

if ( rsssl_admin_logged_in() ) {
	require_once __DIR__ . '/class-rsssl-two-factor-admin.php';
}

if ( is_user_logged_in() ) {
    require_once __DIR__ . '/class-rsssl-two-factor-profile-settings.php';
}

/**
 * Include the backup codes class
 */
require_once __DIR__ . '/class-rsssl-two-factor-backup-codes.php';
require_once __DIR__ . '/interface-rsssl-provider-interface.php';
require_once __DIR__ . '/class-rsssl-two-factor-totp.php';
require_once __DIR__ . '/class-rsssl-two-factor-email.php';
require_once __DIR__ . '/class-rsssl-provider-loader.php';
require_once __DIR__ . '/class-rsssl-two-factor-on-board-api.php';
require_once __DIR__ . '/class-rsssl-two-fa-authentication.php';
require_once __DIR__ . '/Traits/trait-rsssl-email-trait.php';
require_once __DIR__ . '/class-rsssl-two-factor-settings.php';
...
//		add_action( 'login_enqueue_scripts', array( __CLASS__, 'twofa_scripts' ) );
	...
	public static function login_html(
		...
		rsssl_load_template(
			...
			rsssl_path . 'pro/assets/templates/two_fa/'
		);
	...
	private static function onboarding_user_html( WP_User $user ): void {
		...
		// The minified CSS and JS files.
		$minified_css = '';
		if ( file_exists( rsssl_path . 'pro/assets/css/onboarding.min.css' ) ) {
			$minified_css = wp_remote_get( rsssl_path . 'pro/assets/css/onboarding.min.css' );
		}

		$minified_js = '';
		if ( file_exists( rsssl_path . 'pro/assets/js/onboarding.min.js' ) ) {
			$minified_js = wp_remote_get( rsssl_path . 'pro/assets/js/onboarding.min.js' );
		}
